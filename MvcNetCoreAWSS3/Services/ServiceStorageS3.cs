...
namespace MvcNetCoreAWSS3.Services
{
    public class ServiceStorageS3
    {
        ...
        //LA CLASE/INTERFACE PARA TRABAJAR CON LOS BUCKETS SE LLAMA IAmazonS3 
        //Y VAMOS A RECIBIRLA MEDIANTE INYECCION
        ...
        public async Task<bool> UploadFileAsync(string fileName, Stream stream)
        {
            ...
            //PARA TRABAJAR SE UTILIZA LA CLASE IAmazonS3 CON UNA PETICION
            //DE PUTOBJECT
        ...
        public async Task<List<string>> GetVersionsFileAsync()
        {
            ...
            //EXTRAEMOS TODAS LAS KEYS DE NUESTROS FICHEROS, ES DECIR, DE TODOS LOS FICHEROS.
            //POR DEFECTO NOS DEVUELVE LA ULTIMA VERSION.
